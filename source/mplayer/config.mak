...
ASFLAGS    = $(CFLAGS)
AS_DEPFLAGS= -MD -MP -O2 -mcpu=750 -meabi -mogc -msdata -mmultiple -pipe -g -ffast-math -frename-registers
HOSTCC     = $(HOST_CC)
HOSTCFLAGS = -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -O2 -Iffmpeg -I. -I..
HOSTLIBS   = -lm
AS_O       = -o $@
CC_O       = -o $@
...
CONFIG_OPUS_PARSER=no
CONFIG_PNM_PARSER=no
CONFIG_RV30_PARSER=no
CONFIG_RV40_PARSER=no
CONFIG_VC1_PARSER=no
CONFIG_VP3_PARSER=no
CONFIG_VP8_PARSER=no
